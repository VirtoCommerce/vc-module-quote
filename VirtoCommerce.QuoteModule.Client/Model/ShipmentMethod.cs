...
namespace VirtoCommerce.QuoteModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentMethod :  IEquatable<ShipmentMethod>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentMethod {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ShipmentMethod);
        }

        /// <summary>
        /// Returns true if ShipmentMethod instances are equal
        /// </summary>
        /// <param name="other">Instance of ShipmentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
