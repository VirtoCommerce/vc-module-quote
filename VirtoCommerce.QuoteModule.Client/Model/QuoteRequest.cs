...
namespace VirtoCommerce.QuoteModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuoteRequest :  IEquatable<QuoteRequest>
    {
        /// <summary>
        ...
        public List<OperationLog> OperationsLog { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QuoteRequest);
        }

        /// <summary>
        /// Returns true if QuoteRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of QuoteRequest to be compared</param>
        /// <returns>Boolean</returns>
