...
namespace VirtoCommerce.QuoteModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuoteRequestSearchResult :  IEquatable<QuoteRequestSearchResult>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuoteRequestSearchResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QuoteRequestSearchResult);
        }

        /// <summary>
        /// Returns true if QuoteRequestSearchResult instances are equal
        /// </summary>
        /// <param name="other">Instance of QuoteRequestSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuoteRequestSearchResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
