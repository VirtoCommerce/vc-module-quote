...
namespace VirtoCommerce.QuoteModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuoteItem :  IEquatable<QuoteItem>
    {
        /// <summary>
        ...
        public List<TierPrice> ProposalPrices { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QuoteItem);
        }

        /// <summary>
        /// Returns true if QuoteItem instances are equal
        /// </summary>
        /// <param name="other">Instance of QuoteItem to be compared</param>
        /// <returns>Boolean</returns>
