...
namespace VirtoCommerce.QuoteModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuoteRequestTotals :  IEquatable<QuoteRequestTotals>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuoteRequestTotals {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QuoteRequestTotals);
        }

        /// <summary>
        /// Returns true if QuoteRequestTotals instances are equal
        /// </summary>
        /// <param name="other">Instance of QuoteRequestTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuoteRequestTotals other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
