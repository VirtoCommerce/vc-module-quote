...
public class SubmitQuoteCommandBuilder : CommandBuilder<SubmitQuoteCommand, QuoteAggregate, SubmitQuoteCommandType, QuoteType>
{
    ...
    protected override async Task BeforeMediatorSend(IResolveFieldContext<object> context, SubmitQuoteCommand request)
    {
