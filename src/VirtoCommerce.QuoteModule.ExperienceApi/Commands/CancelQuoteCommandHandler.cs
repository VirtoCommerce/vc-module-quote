...
public class CancelQuoteCommandHandler : IRequestHandler<CancelQuoteCommand, QuoteAggregate>
{
    ...
    public async Task<QuoteAggregate> Handle(CancelQuoteCommand request, CancellationToken cancellationToken)
    {
