angular.module('virtoCommerce.quoteModule')
    .controller('virtoCommerce.quoteModule.addressDetailsController',
        ['$scope', '$filter', 'platformWebApp.common.countries', 'platformWebApp.dialogService', 'platformWebApp.metaFormsService', 'platformWebApp.bladeNavigationService',
            function ($scope, $filter, countries, dialogService, metaFormsService, bladeNavigationService) {
                ...
                blade.metaFields = blade.metaFields && blade.metaFields.length ? blade.metaFields : metaFormsService.getMetaFields('QuoteAddressDetails');
                ...
                blade.onClose = function (closeCallback) {
                    bladeNavigationService.showConfirmationIfNeeded(
                        ...
                        $scope.saveChanges,
                        closeCallback,
                        'quotes.dialogs.address-save.title',
                        'quotes.dialogs.address-save.message'
                    );
                };
                ...
                function deleteEntry() {
                    const dialog = {
                        id: 'confirmDelete',
                        title: 'quotes.dialogs.address-delete.title',
                        message: 'quotes.dialogs.address-delete.message',
